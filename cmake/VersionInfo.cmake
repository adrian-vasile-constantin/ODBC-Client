...
function(versioninfo_setup_fileflags OUTVAR)
	...
	if(generator_is_multi_config)
	    ...
	    if(CMAKE_BUILD_TYPE STREQUAL "Debug" OR CMAKE_BUILD_TYPE STREQUAL "DebWithRelInfo" OR CMAKE_BUILD_TYPE IN_LIST debug_configurations_list)
		list(APPEND VERSIONINFO_FILE_FLAGS "VS_FF_DEBUG")
	    endif()
	endif()
    endif()
...
function(versioninfo_fill_icon OUTVAR)
    if(ARGS_MAP_ICON)
...
function(versioninfo_fill_content OUTPUT_FILENAME)
    set(RESOURCE_SCRIPT
	"#include <winver.h>"
	""
    ...
    versioninfo_fill_icon(RESOURCE_SCRIPT)
...
function(VersionInfo_Generate)
	...
	versioninfo_fill_content("${RESOURCE_TEMPLATE_NAME}")
	get_target_property(target_source_directory ${ARGS_MAP_TARGET} SOURCE_DIR)
	...
	versioninfo_fill_content("${RESOURCE_FILE_NAME}")
    endif()
